...
type sampleRing struct {
	...
	// concrete ones for homogenous samples. (Only one of the four bufs must
	// have a len>0!) This avoids the overhead of the interface wrapper for
	// the happy (and by far most common) case of homogenous samples.
	buf   []tsdbutil.Sample
	fBuf  []fSample
	hBuf  []hSample
	fhBuf []fhSample
